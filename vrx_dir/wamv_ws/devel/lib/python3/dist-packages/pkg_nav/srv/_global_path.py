...
"""autogenerated by genpy from pkg_nav/global_pathRequest.msg. Do not edit."""
import codecs
import sys
...
class global_pathRequest(genpy.Message):
  _md5sum = "fa81af3759a6a7f3b889c1a8a75abeef"
  _type = "pkg_nav/global_pathRequest"
...
float64 w
"""
  __slots__ = ['num','start_pose','goal_pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(global_pathRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_i3I().pack(_x.num, _x.start_pose.header.seq, _x.start_pose.header.stamp.secs, _x.start_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.num, _x.start_pose.header.seq, _x.start_pose.header.stamp.secs, _x.start_pose.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_i3I():
    ...
    return _struct_i3I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from pkg_nav/global_pathResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class global_pathResponse(genpy.Message):
  _md5sum = "b27ebad9ce1335e9453c85e2a4e81131"
  _type = "pkg_nav/global_pathResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
float64 w
"""
  __slots__ = ['sum','global_path']
  _slot_types = ['int32','nav_msgs/Path']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(global_pathResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.sum is None:
        self.sum = 0
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_i3I().pack(_x.sum, _x.global_path.header.seq, _x.global_path.header.stamp.secs, _x.global_path.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.sum, _x.global_path.header.seq, _x.global_path.header.stamp.secs, _x.global_path.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
class global_path(object):
  _type          = 'pkg_nav/global_path'
  _md5sum = 'ba39a456f802a4a81c4d35cdebddff8d'
  _request_class  = global_pathRequest
  _response_class = global_pathResponse
