...
"""autogenerated by genpy from pkg_nav/global_pathActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class global_pathActionFeedback(genpy.Message):
  _md5sum = "a92386491e974cc81fc01e0500c5760b"
  _type = "pkg_nav/global_pathActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pkg_nav/global_pathFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(global_pathActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pkg_nav.msg.global_pathFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pkg_nav.msg.global_pathFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2d().pack(_x.feedback.percent_complete, _x.feedback.progress_bar))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.percent_complete, _x.feedback.progress_bar,) = _get_struct_2d().unpack(str[start:end])
      return self
