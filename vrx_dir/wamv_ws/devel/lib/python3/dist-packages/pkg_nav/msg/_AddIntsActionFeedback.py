...
"""autogenerated by genpy from pkg_nav/AddIntsActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class AddIntsActionFeedback(genpy.Message):
  ...
  _type = "pkg_nav/AddIntsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pkg_nav/AddIntsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = pkg_nav.msg.AddIntsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pkg_nav.msg.AddIntsFeedback()
