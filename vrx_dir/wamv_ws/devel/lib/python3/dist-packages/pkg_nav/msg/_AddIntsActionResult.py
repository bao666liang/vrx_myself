...
"""autogenerated by genpy from pkg_nav/AddIntsActionResult.msg. Do not edit."""
import codecs
import sys
...
class AddIntsActionResult(genpy.Message):
  ...
  _type = "pkg_nav/AddIntsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pkg_nav/AddIntsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = pkg_nav.msg.AddIntsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pkg_nav.msg.AddIntsResult()
