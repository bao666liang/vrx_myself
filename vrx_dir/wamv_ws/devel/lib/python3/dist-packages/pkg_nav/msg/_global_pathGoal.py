...
"""autogenerated by genpy from pkg_nav/global_pathGoal.msg. Do not edit."""
import codecs
import sys
...
class global_pathGoal(genpy.Message):
  _md5sum = "aef87d3d36de5fcb43eef8fad3407a39"
  _type = "pkg_nav/global_pathGoal"
...
float64 w
"""
  __slots__ = ['start_pose','goal_pose','goalPoseV1','num']
  _slot_types = ['geometry_msgs/PoseStamped','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped[]','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       start_pose,goal_pose,goalPoseV1,num
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.goalPoseV1)
      buff.write(_struct_I.pack(length))
      for val1 in self.goalPoseV1:
        _v1 = val1.header
        _x = _v1.seq
