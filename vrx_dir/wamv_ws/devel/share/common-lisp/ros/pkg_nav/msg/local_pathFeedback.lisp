...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<local_pathFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Define a feedback message ~%float64 percent_complete  # [0-1]   处理进度 ~%int8    runState  #  -1：处理失败  0 : 未处理     1：正在处理   2：处理完成   ~%~%float64 progress_bar  #test -cyb~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'local_pathFeedback)))
  "Returns full string definition for message of type 'local_pathFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Define a feedback message ~%float64 percent_complete  # [0-1]   处理进度 ~%int8    runState  #  -1：处理失败  0 : 未处理     1：正在处理   2：处理完成   ~%~%float64 progress_bar  #test -cyb~%~%~%"))
