...
let global_pathGoal = require('./global_pathGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class global_pathActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = global_pathGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += global_pathGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new global_pathActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = global_pathGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new global_pathGoal()
    }
...
module.exports = global_pathActionGoal;
